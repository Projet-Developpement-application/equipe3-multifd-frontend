...
const Catalogue = () => {
    ...
    const produits = [
        {
            id: 1,
            name: "ACS255-03U-17A0-6",
            description: "ABB",
            price: "1,850.00",
            image: "https://www.multifd.com/wp-content/uploads/2019/07/image-generique-600x600.jpg"
        },
        {
            id: 2,
            name: "ACS255-03U-17A0-6",
    ...
    return (
        <>
            ...
            {isSidebarOpen && <div className="overlay" onClick={toggleSidebar}></div>} {/* Overlay */}
